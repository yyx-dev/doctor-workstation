...
import com.dw.dao.other.ConsultationDao;
import com.dw.model.other.ConsultationQueue;
...
public class ReceptionPanel extends JPanel {
    ...
    public void refreshData() {
        try {
            java.util.List<ConsultationQueue> queue = dao.getCurrentQueue(doctor.getId());
    ...
    class QueueTableModel extends AbstractTableModel {
        private java.util.List<ConsultationQueue> data = new ArrayList<>();
        private final String[] COLUMNS = {"队列号", "患者姓名", "当前状态", "等待时间"};

        public void setData(java.util.List<ConsultationQueue> data) {
            this.data = data;
